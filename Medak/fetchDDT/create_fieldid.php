...
class createFieldId extends config  {
	...
	public function createFieldId()
  {
    ...
    mysql_query("CREATE TABLE fields_backup ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields");
    mysql_query("CREATE TABLE fields_num_backup ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields_num");
    mysql_query("CREATE TABLE fields_text_backup ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields_text");
		mysql_query("CREATE TABLE latest_igate_data_backup ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM latest_igate_data");
		//$filename="/var/www/$this->plantname/fetchDDT/csv/fields_".date("Y-m-d_H:i:s").".csv";

		mysql_query("CREATE TABLE fields_".date("Y_m_d_H_i_s")." ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields");
    ...
    mysql_query("CREATE TABLE fields_num_".date("Y_m_d_H_i_s")." ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields_num");
    ...
    mysql_query("CREATE TABLE fields_text_".date("Y_m_d_H_i_s")." ENGINE=MYISAM CHARSET=latin1 COLLATE=latin1_swedish_ci SELECT * FROM fields_text");
		...
		//mysql_query("CREATE TABLE latest_igate_data_".date("Y_m_d_H_i_s")." ENGINE=MYISAM CHARSET=latin1 COLLATE=utf8_bin SELECT * FROM latest_igate_data");
