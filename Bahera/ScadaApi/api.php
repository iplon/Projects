   ...
   private function smucomparison()
		{
			...
			echo $selectQuery = "select a.ts,a.device_name,b.module,a.smustatus,a.modulecldate,a.duration,a.moduleduedate from smucomparison_data AS a JOIN smustringconn AS b ON(a.device_name=b.device) where a.ts = '".$startTime."' $where order by a.blockname,a.device_name";
