...
$route['test1/(:any)'] = 'report/excel_down/$1/$2';
$route['test2/(:any)'] = 'report/pdf_down/$1/$2';
...
$route['ctest3/(:any)'] = 'cron/ods_down/$1';


$route['upload'] = 'cron/do_upload';

$route['cron'] = 'cron/index';



$route['download_zip'] = 'report/download_zip';


$route['pkill_soffice'] = 'report/pkill_soffice';
