		...
		if(($this->chr <= 23)&&($min < 50))
{
		...
		$slq2 = "SELECT blockname,device_name,field,SUM(value) AS value from scada_latest_igate_data 
		WHERE device_name LIKE '%INV%' AND device_name NOT LIKE '%SMU%' AND field = 'EAE_DAY' AND ts >= $this->startTime AND ts < $this->endTime";
